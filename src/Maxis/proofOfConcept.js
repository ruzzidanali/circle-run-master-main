...
const inputPath = "Z://System//01 Utility Bill//07 Maxis//2508//Maxis_2508_CYBER&P8.pdf";
...
const outputPath =
  "C:/Users/PC/Desktop/PDFExtractorTesting/Maxis_2508_PUJ_MULTI_ALLPAGES.pdf";
...
async function drawBoxes() {
  ...
  const boxesPerPage = [
    [
      { x: 50, y: 652, w: 100, h: 12 },
      { x: 480, y: 535, w: 70, h: 17 },
      { x: 230, y: 687, w: 140, h: 10 },
      { x: 230, y: 665, w: 140, h: 10 },
      { x: 480, y: 592, w: 70, h: 12 },
      { x: 230, y: 642, w: 140, h: 10 },
      //   { x: 515, y: 211, w: 30, h: 10 },
    ],

    [
      { x: 485, y: 548, w: 60, h: 16 },
      { x: 485, y: 600, w: 60, h: 16 },
      { x: 485, y: 575, w: 60, h: 17 },
      //   { x: 515, y: 211, w: 30, h: 10 },
    ],
