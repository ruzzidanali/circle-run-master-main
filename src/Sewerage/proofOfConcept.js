...
const inputPath = "Z://System//01 Utility Bill//05 Sewerage//2507//SEWERAGE_2507_CYBERJ.pdf";
...
const outputPath =
  "C:/Users/PC/Desktop/PDFExtractorTesting/Sewerage_2508_PUJ_MULTI_ALLPAGES.pdf";
...
async function drawBoxes() {
  ...
  const boxesPerPage = [
    [
      { x: 385, y: 810, w: 100, h: 10 },
      { x: 385, y: 800, w: 100, h: 10 },
      { x: 460, y: 783, w: 70, h: 10 },
      { x: 365, y: 410, w: 45, h: 10 },
      { x: 370, y: 455, w: 45, h: 20 },
      //   { x: 515, y: 211, w: 30, h: 10 },
      { x: 317, y: 447, w: 50, h: 10 },
      { x: 45, y: 542, w: 80, h: 27 },
      { x: 160, y: 210, w: 50, h: 22 },
    ],
